...
require __DIR__ . '/model/MariaDbIp.php';
...
Type::addType(Inet4Type::NAME, Inet4Type::class);
...
$db->getDatabasePlatform()->registerDoctrineTypeMapping(Inet4Type::NATIVE_TYPE, Inet4Type::NAME);
