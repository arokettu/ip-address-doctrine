...
use Arokettu\IP\Doctrine\Demo\IpInSqlite;
...
/** @var IpInSqlite $ip1_found */
$ip1_found = $em->find(IpInSqlite::class, $id1);
...
/** @var IpInSqlite $ip2_found */
$ip2_found = $em->find(IpInSqlite::class, $id2);
...
/** @var IpInSqlite $ip3_found */
$ip3_found = $em->find(IpInSqlite::class, $id3);
